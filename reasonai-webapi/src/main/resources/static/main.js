...
var app = new Vue({
  ...
  methods: {
    ...
    scrollThreadToBottom: function () {
      const chatMessageList = document.getElementById("chat-thread-message-list-wrapper");
    ...
    deleteTheme: function (date, index) {
      this.chatThemes[date].themes.splice(index, 1);
    },
